                                                ...
                                                <div class="flex flex-row gap-1 w-100">
                                                    ...
                                                    <div class="basis-4/5">
                                                        <div class="flex items-center">
                                                            <input id="checked-checkbox" {{$filter["value"]? "checked":""}} name="filters[{{$filter["name"]}}]" type="checkbox" value="true" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
