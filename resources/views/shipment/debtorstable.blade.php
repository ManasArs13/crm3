            ...
            <div class="CEB__wrapTable mb-5">
                <table class="sum sum1">
                    ...
                    @foreach($shipments as $shipment)
                        <tr>
                            <td class="text-start pl-2 pt-1 pb-2 pr-2 overflow-auto"><a href="https://online.moysklad.ru/app/#Company/edit?id={{$shipment->ms_id}}" target="__blank">{{ $shipment->name }}</a></td>
                            <td class="text-end pl-2 pt-1 pb-2 pr-2">{{ $shipment->moment}}</td>
                            <td class="text-end pl-2 pt-1 pb-2 pr-2">{{ $shipment->days }}</td>
                            <td class="text-end pl-2 pt-1 pb-2 pr-2">{{ $shipment->balance }}</td>
                            <td class="text-start pl-2 pt-1 pb-2 pr-2 overflow-auto"><div class="comment">{{ $shipment->description }}</div></td>
                            <td class="text-start pl-2 pt-1 pb-2 pr-2">
                    ...
                    @endforeach
                    <tr>
                        <td class="text-end pl-2 pt-1 pb-2 pr-2"></td>
                        <td class="text-end pl-2 pt-1 pb-2 pr-2"></td>
                        <td class="text-end pl-2 pt-1 pb-2 pr-2"></td>
                        <td class="text-end pl-2 pt-1 pb-2 pr-2"><b>{{ $sum}}</b></td>
                        <td class="text-end pl-2 pt-1 pb-2 pr-2"></td>
                        <td class="text-end pl-2 pt-1 pb-2 pr-2"></td>
                    </tr>
