            ...
            <div class="CEB__wrapTable mb-5">
                <table class="sum sum1">
                    ...
                    @foreach($shipments as $shipment)
                        <tr>
                            <td class="text-start pl-2 pt-1 pb-2 pr-2"><a href="https://online.moysklad.ru/app/#Company/edit?id={{$shipment->ms_id}}" target="__blank">{{ $shipment->name }}</a></td>
                            ...
                            <td class="text-start pl-2 pt-1 pb-2 pr-2"><div class="comment">{{ $shipment->description }}</div></td>
