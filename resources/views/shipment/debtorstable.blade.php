                ...
                <table class="sum sum1">
                    <tr>
                        <th class="bg-neutral-200 font-semibold text-start pl-2 pt-1 pb-2 pr-2 w-4/12">
                            {{ __('column.name') }}</th>
                        <th class="bg-neutral-200 font-semibold text-start pl-2 pt-1 pb-2 pr-2 w-2/12">
                                {{ __('column.date_of_last_shipment') }}</th>
                        <th class="bg-neutral-200 font-semibold text-start pl-2 pt-1 pb-2 pr-2 w-1/12">
                                {{ __('column.days') }}</th>
                        <th class="bg-neutral-200 font-semibold text-start pl-2 pt-1 pb-2 pr-2 w-1/12">
                    ...
                    @foreach($shipments as $shipment)
                        <tr>
                            ...
                            <td class="text-start pl-2 pt-1 pb-2 pr-2 w-1/12">
