                ...
                <table class="sum sum1">
                    ...
                    @foreach($shipments as $shipment)
                        <tr>
                            ...
                            <td class="text-end pl-2 pt-1 pb-2 pr-2 w-1/12">{{ $shipment->moment}}</td>
                            ...
                            <td class="text-start pl-2 pt-1 pb-2 pr-2 overflow-auto w-4/12"><div class="comment">{{ $shipment->description }}</div></td>
