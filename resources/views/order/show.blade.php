                            ...
                            <div class="basis-1/3">
                                <div class="flex flex-row mb-1 w-full">
                                    ...
                                    <select name="status" required style="background-color: {{ $entityItem->status->color }}"
                                        class="relative m-0 flex basis-full rounded border border-solid border-neutral-300 px-3 py-[0.25rem] text-base font-normal leading-[1.6] text-surface outline-none transition duration-200 ease-in-out placeholder:text-neutral-500 focus:z-[3] focus:border-primary focus:shadow-inset focus:outline-none motion-reduce:transition-none dark:border-white/10 dark:text-white dark:placeholder:text-neutral-200 dark:autofill:shadow-autofill dark:focus:border-primary">
