    ...
    <div class="w-11/12 max-w-7xl mx-auto py-8">
        ...
        <div
            ...
            <div class="flex flex-col w-100 p-1 bg-white overflow-x-auto">
                <form action="{{ route($action, ['incoming' => $incoming->id]) }}" method="post">
                    @csrf
                    @method("PATCH")
                    ...
                    <div class="min-h-6 px-5 py-1">
                        ...
                        <div class="flex flex-row basis-full justify-end my-2">
                            <span class="font-light text-sm">обновлено: {{ $incoming->updated_at }}</span>
                        </div>
                        ...
                        <div x-data="products">
                            ...
                            <div class="flex flex-row mb-1 w-full rounded p-2">
                                <div class="flex basis-8/12">
                                    <textarea name="description" class="w-full rounded border-neutral-200" placeholder="Комментарий">{{ $incoming->description }}</textarea>
                                </div>
