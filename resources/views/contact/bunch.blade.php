                                    ...
                                    @foreach ($resColumns as $column => $title)
                                        <td class="break-all max-w-64 overflow-auto px-2 py-2 truncate"
                                            ...
                                            @elseif($column == 'shipment_id_ms')
                                                {{ isset($entityItem->contact->shipments) ? $entityItem->contact->shipments->sum('products_sum_quantity_price') : '-' }}
                                            @elseif($column == 'shipment_id_amo')
                                                {{ isset($entityItem->AmoContact->amo_order) ? $entityItem->AmoContact->amo_order->sum('price') : '-' }}
